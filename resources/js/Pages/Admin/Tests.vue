                    ...
                    <div class="p-6 text-gray-900">
                        <div class="mb-4 min-w-full overflow-hidden overflow-x-auto align-middle sm:rounded-md">
                            <table class="min-w-full border divide-y divide-gray-200">
                                ...
                                <tr class="bg-white" v-else v-for="test in tests.data">
                                    ...
                                    <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                        {{ test.time_spent }} minutes
                                    </td>
                                    <td>
                                        <Link :href="route('results.show', test)" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                                            View
                                        </Link>
                                    </td>
                                </tr>
