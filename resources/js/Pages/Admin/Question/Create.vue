                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <form @submit.prevent="form.post(route('questions.store'))">
                        ...
                        <div class="p-6 pt-2">
                            ...
                            <input v-model="form.moreInfo" type="text" id="info" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class="text-red-600 mt-1">
                            <div v-if="errors.moreInfo" class="text-red-600">
                                {{ errors.moreInfo }}
                            </div>
                        </div>
...
form.question_options.push({option: 'Example option', correct: true})
